...
export const metadata: Metadata = {
    ...
    description: "Join our workshops, seminars, and networking events at ICFAI Startup & Incubation Center. Enhance your entrepreneurial journey and connect with innovators.",
