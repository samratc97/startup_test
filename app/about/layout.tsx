...
export const metadata: Metadata = {
  ...
  description: "Learn more about ICFAI Startup & Incubation Center, our mission, vision, team, and the impact we are making in fostering entrepreneurship and innovation.",
