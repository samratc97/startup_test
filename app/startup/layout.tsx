...
export const metadata: Metadata = {
    ...
    description: "Discover innovative startups incubated at ICFAI University Tripura. View our portfolio of successful companies transforming ideas into market-ready solutions.",
