...
export const metadata: Metadata = {
  ...
  description: "Meet the dedicated team behind ICFAI Startup & Incubation Center - experienced professionals committed to fostering entrepreneurship and innovation.",
