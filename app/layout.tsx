...
export const metadata: Metadata = {
  title: {
    default: "ICFAI Startup & Incubation Center",
    template: "%s | ICFAI Startup Center"
  },
  description: "Startup & Incubation Center at ICFAI University Tripura - Fostering entrepreneurship and innovation through comprehensive support, mentorship, and resources.",
